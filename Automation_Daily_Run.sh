...
hive -f /Hive_Scripts/Daily_Run/load_data_stg_daily.hql

## Hive - Update intermediate tables

hive -f /Hive_Scripts/Daily_Run/update_aggrigate_daily_run.hql

## Hive - Update aggrigate tables

hive -f /Hive_Scripts/Daily_Run/update_intermediate_daily_run.hql
